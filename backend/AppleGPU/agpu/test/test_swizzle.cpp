...
// bijection, or two logical elements alias in threadgroup memory.
...
int main() {
  ...
  {
    // Under a permutation the corner is no longer the highest offset, so
    // sizing from it under-reserves.
