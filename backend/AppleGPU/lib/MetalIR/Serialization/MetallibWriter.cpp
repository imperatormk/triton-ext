...
bool writeMetallib(Module &M, const PointeeTypeMap &PTM, raw_ostream &OS,
                   const MetallibOptions &opts) {
  ...
  writeU64(OS, sec0_offset);
  writeU64(OS, sec0_size);
  writeU64(OS, sec1_offset);
  writeU64(OS, sec1_size);
  writeU64(OS, sec2_offset);
  writeU64(OS, sec2_size);
  writeU64(OS, sec3_offset);
  writeU64(OS, sec3_size);
