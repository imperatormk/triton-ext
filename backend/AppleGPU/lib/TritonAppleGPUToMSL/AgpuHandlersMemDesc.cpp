...
// An encoding whose offsets are a strided tile permuted by an XOR. The
// parameters are searched because the encoding states them in its own terms,
// and each candidate is checked against the layout.
