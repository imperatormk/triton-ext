...
/// Initializer for the Metal cross-buffer store-separate pass.
void initializeMetalCrossBufferStoreSeparateLegacyPass(PassRegistry &);
...
ModulePass *createMetalCrossBufferStoreSeparateLegacyPass();
