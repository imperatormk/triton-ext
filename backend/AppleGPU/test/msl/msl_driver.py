...
Importing ``triton_apple_backend`` registers the pass with Triton; both Triton
and the extension must be installed (``make build install``).

Run by hand with::

    ./msl_driver.py shared-swizzle.mlir
"""
